...
void LocoMotor::Scripting::ScriptManager::registerCore() {
	...
	luabridge::getGlobalNamespace(_luaState)
		...
		.addFunction("addRigidBody", std::function<RigidBody *(GameObject*)>([](GameObject* g) { return (RigidBody*)g->addComponent("RigidBody"); }))
		.addFunction("addMeshRenderer", std::function<MeshRenderer *(GameObject*)>([](GameObject* g) { return (MeshRenderer*)g->addComponent("MeshRenderer"); }))
		.addFunction("addCamera", std::function<Camera *(GameObject*)>([](GameObject* g) { return (Camera*)g->addComponent("Camera"); }))
		.addFunction("addParticleSystem", std::function<ParticleSystem *(GameObject*)>([](GameObject* g) { return (ParticleSystem*)g->addComponent("ParticleSystem"); }))
		.addFunction("addEventEmitter", std::function<EventEmitter *(GameObject*)>([](GameObject* g) { return (EventEmitter*)g->addComponent("EventEmitter"); }))
		.addFunction("addAudioSource", std::function<AudioSource *(GameObject*)>([](GameObject* g) { return (AudioSource*)g->addComponent("AudioSource"); }))
		.addFunction("addAudioListener", std::function<AudioListener *(GameObject*)>([](GameObject* g) { return (AudioListener*)g->addComponent("AudioListener"); }))
		.addFunction("addUIText", std::function<UIText *(GameObject*)>([](GameObject* g) { return (UIText*)g->addComponent("UIText"); }))
		.addFunction("addUIImage", std::function<UIImage *(GameObject*)>([](GameObject* g) { return (UIImage*)g->addComponent("UIImage"); }))
		.addFunction("addSelectable", std::function<Input::Selectable * (GameObject*)>([](GameObject* g) { return (Input::Selectable*) g->addComponent("Selectable"); }))
		.addFunction("addLuaComponent", std::function<luabridge::LuaRef(GameObject*, const std::string & s)>([](GameObject* g, const std::string& s) { return ((LuaBehaviour*) g->addComponent(s))->getScript(); }))
		...
		.addFunction("getCamera", &GameObject::getComponent<Camera>)
		.addFunction("getParticleSystem", &GameObject::getComponent<ParticleSystem>)
